...
public interface AllocationService {
    ...
    /**
     * Gán chỗ thủ công cho sinh viên vào giường (§6.3.6 bước 9)
     * Khóa period hoặc system_locks.ALLOCATION, khóa giường bằng findByIdForUpdate, kiểm tra giới tính và trạng thái.
     */
