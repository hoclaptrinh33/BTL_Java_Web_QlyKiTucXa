...
public class ContractServiceImpl implements ContractService {
    ...
    public Contract createDraftFromAllocation(RoomApplication app, Bed bed, LocalDate termStart, LocalDate termEnd) {
        ...
        return createDraft(app.getStudent(), app, bed, termStart, termEnd);
    }

    @Override
    @Transactional
    public Contract createDraft(com.ktx.domain.Student student, RoomApplication app, Bed bed, LocalDate termStart, LocalDate termEnd) {
